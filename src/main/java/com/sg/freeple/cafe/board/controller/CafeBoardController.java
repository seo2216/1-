...
//	@RequestMapping("produceCafeBoardCategoryPage")
//	public String produceCafeBoardCategoryPage(Model model,int cafe_no, HttpSession session) {
//		
//		FP_MemberVo memberVo = (FP_MemberVo) session.getAttribute("sessionUserInfo");
//		FP_CafeMemberVo cafeMemberVo = cafeService.getCafeMemberDataByMemberNo(cafe_no, memberVo.getMb_no());
...
//		model.addAttribute("cafeVo2", cafeVo2);
//		
//		return "cafe/cafeBoard/produceCafeBoardCategoryPage";
//	}
	
//	@RequestMapping("produceBoardCategoryProcess")
//	public String produceBoardCategoryProcess(FP_CafeBoard_CategoryVo cafeBoard_CategoryVo) {
//		
//		cafeBoardService.createBoardCategory(cafeBoard_CategoryVo);
//		
//		return "redirect: ./cafeBoardPage?cafe_no="+ cafeBoard_CategoryVo.getCafe_no();
//	}
	...
	public String cafeBoardViewPage(Model model,int writeBoard_no, HttpSession session) {
		...
		FP_WriteBoardVo writeBoardVo = (FP_WriteBoardVo) data.get("writeBoardVo"); 
