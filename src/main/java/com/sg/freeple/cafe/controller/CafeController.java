...
//	@RequestMapping("requestToJoinProcess") //카페가입요청
//	public String registerCafeProcess(FP_RequestToJoinVo requestToJointVo) {
//	
//		cafeService.RequestToJoinMember(requestToJointVo);	
//		return "redirect: ./registerCompletePage?cafe_no="+ requestToJointVo.getCafe_no();
//	}
