...
public class FP_FreepReviewReplyVo {
		...
		public FP_FreepReviewReplyVo() {
			super();
		}

		public FP_FreepReviewReplyVo(int review_reply_no, int review_no, int freep_no, int mb_no,
				String comment_content, Date comment_writedate) {
			super();
