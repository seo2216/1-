            	...
            	<div class="row mx-4 py-3">
					<div class="col">
						<div class="row fs-3 fw-bold py-4">
							<div class="col text-center"><i class="bi bi-info-circle"></i>&nbsp;이미 가입 요청을 했습니다.</div>
						</div>
						<div class="row py-2">
							<div class="col fs-5 text-center">카페 관리자의 승인이 있어야 카페 활동이 가능합니다.</div>
						</div>
						<div class="row pt-5">
							<div class="col"></div>
							<div class="col-6 d-grid"><a href="./cafeListPage" class="btn" style="background-color: #ab79d1; color: white;" type="button">카페 목록으로</a></div>
							<div class="col"></div>
						</div>
					</div>
            	</div>
