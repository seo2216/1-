            	...
            	<div class="col">
	            	<div class="row ms-5">
	            		<div class="col">
	            			<div class="row border-2 border-bottom border-balck py-4">
	            				<div class="col">
	            					<div class="row"><div class="col fw-bold fs-3"><i class="bi bi-layout-text-sidebar"></i>&nbsp;${cafeBoard_CategoryVo.cafeBoard_Category_name }</div></div>
	            					<div class="row pt-3">
	            			...
	            			<div class="row py-3 border-2 border-bottom border-balck">
	            				<div class="col">
	            					<div class="row">
	            						<div class="col-2 fw-bold">글번호</div>
	            			...
	            			<div class="row">
	            				...
	            				<div class="col-12"><!-- 반목문돌기 -->
	            					<div class="row border-bottom border-balck py-3" onclick="location.href='./cafeBoardViewPage?writeBoard_no=${data.writeBoardVo.writeBoard_no}'">
	            						<div class="col-2 ms-1">${data.writeBoardVo.writeBoard_no }</div>
	            	...
	            	<div class="row">
	                  ...
	                  <div class="col d-grid py-3"> 
		                  <a class="btn" style="background-color: #ab79d1; color: white;" href="./writeBoardPage?cafe_no=${cafeBoard_CategoryVo.cafe_no}&cafeBoard_Category_no=${cafeBoard_CategoryVo.cafeBoard_Category_no}" role="button">
		                  <i class="bi bi-pencil"></i>&nbsp;글쓰기</a>
	                  </div>
	                </div>            	
            	</div>
            </div>
