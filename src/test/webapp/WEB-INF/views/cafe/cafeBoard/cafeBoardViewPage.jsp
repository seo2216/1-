		...
		if(xhr.readyState == 4 && xhr.status == 200){
            ...
            for(commentData of jsonObj.data){
                ...
                innerRow2.appendChild(contentBox)
                 ...
                 tempCol2.classList.add("col-1")
                 tempCol2.classList.add("text-secondary")
                 tempCol2.innerText = "답글쓰기"
                 innerRow3.appendChild(tempCol2)
                 
                 var tempCol7 = document.createElement("div")
                 tempCol7.classList.add("col")
                 innerRow3.appendChild(tempCol7)
		                                ...
		                                <div class="col">
		                                	<div class="row pb-4">
		                                		<div class="col"><!-- 본문 이미지 -->
		                                			<c:forEach items="${data.cafeBoImageList }" var="cafeBoImage">
		                                				<div class="col pb-2">
		                                				<img class="img-fluid" src="/uploadFiles/${cafeBoImage.cafeBoImage_link }">
		                                				</div>
		                                			</c:forEach>
		                                		</div>
		                                	</div>
		                                	<div class="row">
		                                		<div class="col fs-5">${data.writeBoardVo.writeBoard_cotent}</div>
		                                	</div> 
		                                </div>
		                            </div>
		                            <div class="row">
		                                    ...
		                                    <div class="row py-2">
		                                    	...
		                                    	<div class="col-3"> <!-- 기능 추가해야함 -->
				                                    <div class="row mt-2" id="nickname">
				                                    	...
				                                    	<c:otherwise>
				                                    		<div class="col-3 p-0 fw-bolder ms-3">${data.cafeMemberVo.cafeMember_nickname }</div>
