     ...
     <div class="row">
         <div class="col">
             ...
             <div class="row pt-1 pb-3">
                 <div class="col d-grid">
                     <a role="button" class="btn btn-outline-secondary" href="./cafeBoard/cafeBoardSettingPage?cafe_no=${cafeVo.cafe_no }">게시판 관리</a>
                 </div>
             </div>
             </c:if>
             <div class="row border-top black py-3"><!---->
                 <div class="col">
                     <div class="row">
                         <div class="col">카페주제 ></div>
                         <div class="col text-start">아웃도어</div>
                     </div>
                     <div class="row">
                         <div class="col">회원수 : ${cafeVo2.cafeMember_limit}</div>
             ...
             <div class="row border-top black py-2"><!--글쓰기-->
                 <div class="col d-grid">
                     <a role="button" class="btn btn-secondary" href="./cafeBoard/writeCafeBoardPage?cafe_no=${cafeVo.cafe_no}">카페 글쓰기</a>
                 </div>
             </div>
             </c:if>
             ...
             <div class="row black py-2">
                 <div class="col d-grid"><!--가입하기-->
                     <a role="button" class="btn" style="color:#8A2BE2; border: 2px solid #8A2BE2;" href="./registerCafeMemberPage?cafe_no=${cafeVo.cafe_no }">가입하기</a>
                 </div>
             </div>
             </c:if>
         </div>
     	...
     	<div class="col">
		     ...
		     <div class="row border-bottom border-balck py-2"><!--카테고리-->
		         <div class="col text-center p-0">
		             ...
		             href="../cafe/cafeBoard/boardByCategoryPage?cafe_no=${data.cafeBoard_CategoryVo.cafe_no }&cafeBoard_Category_no=${data.cafeBoard_CategoryVo.cafeBoard_Category_no}" 
		             role="button">
