									...
									<div class="col">
										...
										<div class="card pt-3" style="border-color:#a273de;background-color:#f9f5fc">
											...
											<div
												...
												class="carousel slide font-team" data-bs-ride="carousel">
											...
											<div class="card-body">
												...
												<br> 
												<a class="" href=""></a> <a style="font-size:13px; background-color: #a273de; border-color:  #a273de;"
													class="btn btn-primary"
													href="./feedCommentWritePage?review_no=${reviewDataList.fp_FreepReviewVo.review_no }">댓글</a>
											</div>
										</div>
									</div>
								</c:forEach>
