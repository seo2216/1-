	...
	<div style="width:1200px; margin: 0 auto">
		<div class="container-fluid">
			...
			<div class="row my-5">
				...
				<form id="form" action="../login/secondFindPwPage" method="post">	
					...
					<div class="row my-4">
						<div class="col d-grid">
							<input type="button" onclick="doSubmit()" value="이메일 링크 보내기" class="btn btn-primary">
						</div>						
					</div>
				</form>
