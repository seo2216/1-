				...
				<div class="col">
					<div class="row my-5">
						...
						<div class="col text-center font-team" style="width: auto;">
							<a href="./myReviewPage" style="text-decoration: none"> <i
								class="bi bi-book"
								style="color: #a273de; font-size: 19pt; display: block;"></i> <span
								style="display: block; color: #ab79d1;">마이리뷰</span>
							</a>
						</div>
								...
								<c:forEach items="${reviewDataList}" var="reviewDataList">
										...
										<div class="card pt-3" style="border-color : #a273de; background-color:#f9f5fc">
											...
											<div
												...
												class="carousel slide px-2" data-bs-ride="carousel">
